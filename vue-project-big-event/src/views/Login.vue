    ...
    <el-row class="login-page">
        ...
        <el-col :span="6" :offset="3" class="form">
          ...
          <el-form v-if="!isRegister && !isForgetPassword && !isResetPassword" ref="loginForm" size="large"
            ...
            <el-form-item class="flex">
              <el-link type="info" :underline="false" @click=";(isForgetPassword = true), clearData()"> 忘记密码？</el-link>
            </el-form-item>
            <!-- 登录按钮 -->
            <el-form-item>
          ...
          <el-form v-if="isResetPassword" ref="resetPasswordForm" size="large" autocomplete="off"
            ...
            <el-form-item class="flex">
              <el-link type="info" :underline="false" @click=";(isResetPassword = falsem), clearData()"> 返回忘记密码
              </el-link>
            </el-form-item>
          </el-form>
        </el-col>
